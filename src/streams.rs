...
impl GeneralStream {
    ...
    mediainfo_attr!(overall_bit_rate_minimum_string, "OverallBitRate_Minimum/String");
    mediainfo_i64!(overall_bit_rate_nominal, "OverallBitRate_Nominal");
    mediainfo_attr!(overall_bit_rate_nominal_string, "OverallBitRate_Nominal/String");
    mediainfo_i64!(overall_bit_rate_maximum, "OverallBitRate_Maximum");
    mediainfo_attr!(overall_bit_rate_maximum_string, "OverallBitRate_Maximum/String");
    ...
    mediainfo_attr!(album_replay_gain_gain_string, "Album_ReplayGain_Gain/String");
    ...
    mediainfo_attr!(encryption_initialization_vector, "Encryption_InitializationVector");
...
impl VideoStream {
    ...
    mediainfo_attr!(format_settings_reframes_string, "Format_Settings_ReFrames/String");
    mediainfo_i64!(format_settings_ref_frames, "Format_Settings_RefFrames");
    mediainfo_attr!(format_settings_ref_frames_string, "Format_Settings_RefFrames/String");
    mediainfo_attr!(format_settings_matrix, "Format_Settings_Matrix");
    mediainfo_attr!(format_settings_matrix_string, "Format_Settings_Matrix/String");
    ...
    mediainfo_attr!(format_settings_picture_structure, "Format_Settings_PictureStructure");
    ...
    mediainfo_attr!(format_settings_slice_count_string, "Format_Settings_SliceCount/String");
    ...
    mediainfo_attr!(source_duration_first_frame_string, "Source_Duration_FirstFrame/String");
    mediainfo_attr!(source_duration_first_frame_string1, "Source_Duration_FirstFrame/String1");
    mediainfo_attr!(source_duration_first_frame_string2, "Source_Duration_FirstFrame/String2");
    mediainfo_attr!(source_duration_first_frame_string3, "Source_Duration_FirstFrame/String3");
    mediainfo_attr!(source_duration_first_frame_string4, "Source_Duration_FirstFrame/String4");
    mediainfo_attr!(source_duration_first_frame_string5, "Source_Duration_FirstFrame/String5");
    
    mediainfo_i64!(source_duration_last_frame, "Source_Duration_LastFrame");
    mediainfo_attr!(source_duration_last_frame_string, "Source_Duration_LastFrame/String");
    mediainfo_attr!(source_duration_last_frame_string1, "Source_Duration_LastFrame/String1");
    mediainfo_attr!(source_duration_last_frame_string2, "Source_Duration_LastFrame/String2");
    mediainfo_attr!(source_duration_last_frame_string3, "Source_Duration_LastFrame/String3");
    mediainfo_attr!(source_duration_last_frame_string4, "Source_Duration_LastFrame/String4");
    mediainfo_attr!(source_duration_last_frame_string5, "Source_Duration_LastFrame/String5");
    ...
    mediainfo_attr!(pixel_aspect_ratio_original_string, "PixelAspectRatio_Original/String");
    mediainfo_attr!(pixel_aspect_ratio_clean_aperture, "PixelAspectRatio_CleanAperture");
    mediainfo_attr!(pixel_aspect_ratio_clean_aperture_string, "PixelAspectRatio_CleanAperture/String");
    ...
    mediainfo_attr!(display_aspect_ratio_original_string, "DisplayAspectRatio_Original/String");
    mediainfo_attr!(display_aspect_ratio_clean_aperture, "DisplayAspectRatio_CleanAperture");
    mediainfo_attr!(display_aspect_ratio_clean_aperture_string, "DisplayAspectRatio_CleanAperture/String");
    
    // Active format description
    mediainfo_attr!(active_format_description, "ActiveFormatDescription");
    mediainfo_attr!(active_format_description_string, "ActiveFormatDescription/String");
    mediainfo_attr!(active_format_description_muxing_mode, "ActiveFormatDescription_MuxingMode");
    ...
    mediainfo_attr!(active_display_aspect_ratio_string, "Active_DisplayAspectRatio/String");
    ...
    mediainfo_attr!(frame_rate_mode_original_string, "FrameRate_Mode_Original/String");
    ...
    mediainfo_attr!(scan_type_store_method_fields_per_block, "ScanType_StoreMethod_FieldsPerBlock");
    ...
    mediainfo_attr!(scan_order_stored_displayed_inverted, "ScanOrder_StoredDisplayedInverted");
...
impl AudioStream {
    ...
    mediainfo_attr!(format_settings_mode_extension, "Format_Settings_ModeExtension");
    ...
    mediainfo_attr!(channel_positions_original_string2, "ChannelPositions_Original/String2");
    mediainfo_attr!(matrix_channel_positions, "Matrix_ChannelPositions");
    mediainfo_attr!(matrix_channel_positions_string2, "Matrix_ChannelPositions/String2");
    ...
    mediainfo_attr!(source_stream_size_proportion, "Source_StreamSize_Proportion");
    ...
    mediainfo_attr!(stream_size_encoded_proportion, "StreamSize_Encoded_Proportion");
    
    mediainfo_i64!(source_stream_size_encoded, "Source_StreamSize_Encoded");
    mediainfo_attr!(source_stream_size_encoded_string, "Source_StreamSize_Encoded/String");
    mediainfo_attr!(source_stream_size_encoded_string1, "Source_StreamSize_Encoded/String1");
    mediainfo_attr!(source_stream_size_encoded_string2, "Source_StreamSize_Encoded/String2");
    mediainfo_attr!(source_stream_size_encoded_string3, "Source_StreamSize_Encoded/String3");
    mediainfo_attr!(source_stream_size_encoded_string4, "Source_StreamSize_Encoded/String4");
    mediainfo_attr!(source_stream_size_encoded_string5, "Source_StreamSize_Encoded/String5");
    mediainfo_attr!(source_stream_size_encoded_proportion, "Source_StreamSize_Encoded_Proportion");
    ...
    mediainfo_attr!(encoded_application, "Encoded_Application");
    mediainfo_attr!(encoded_application_string, "Encoded_Application/String");
    mediainfo_attr!(encoded_application_company_name, "Encoded_Application_CompanyName");
...
impl ImageStream {
    ...
    mediainfo_attr!(colour_description_present_source, "colour_description_present_Source");
    mediainfo_attr!(colour_description_present_original, "colour_description_present_Original");
    mediainfo_attr!(colour_description_present_original_source, "colour_description_present_Original_Source");
    ...
    mediainfo_attr!(colour_primaries_original_source, "colour_primaries_Original_Source");
    
    mediainfo_attr!(transfer_characteristics, "transfer_characteristics");
    mediainfo_attr!(transfer_characteristics_source, "transfer_characteristics_Source");
    mediainfo_attr!(transfer_characteristics_original, "transfer_characteristics_Original");
    mediainfo_attr!(transfer_characteristics_original_source, "transfer_characteristics_Original_Source");
    ...
    mediainfo_attr!(matrix_coefficients_original_source, "matrix_coefficients_Original_Source");
    
    // Mastering display
    mediainfo_attr!(mastering_display_color_primaries, "MasteringDisplay_ColorPrimaries");
    mediainfo_attr!(mastering_display_color_primaries_source, "MasteringDisplay_ColorPrimaries_Source");
    mediainfo_attr!(mastering_display_color_primaries_original, "MasteringDisplay_ColorPrimaries_Original");
    mediainfo_attr!(mastering_display_color_primaries_original_source, "MasteringDisplay_ColorPrimaries_Original_Source");
    
    mediainfo_attr!(mastering_display_luminance, "MasteringDisplay_Luminance");
    mediainfo_attr!(mastering_display_luminance_source, "MasteringDisplay_Luminance_Source");
    mediainfo_attr!(mastering_display_luminance_original, "MasteringDisplay_Luminance_Original");
    mediainfo_attr!(mastering_display_luminance_original_source, "MasteringDisplay_Luminance_Original_Source");
...
impl TextStream {
    ...
    mediainfo_attr!(duration_start_command_string, "Duration_Start_Command/String");
    mediainfo_attr!(duration_start_command_string1, "Duration_Start_Command/String1");
    mediainfo_attr!(duration_start_command_string2, "Duration_Start_Command/String2");
    mediainfo_attr!(duration_start_command_string3, "Duration_Start_Command/String3");
    mediainfo_attr!(duration_start_command_string4, "Duration_Start_Command/String4");
    mediainfo_attr!(duration_start_command_string5, "Duration_Start_Command/String5");
